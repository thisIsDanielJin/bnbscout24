...
void main() {
  runApp(MaterialApp(
    ...
    items: [
      CustomTabBarItem(
          page: HomePage(), tab_widget: FaIcon(FontAwesomeIcons.map)),
      CustomTabBarItem(
          page: SearchPage(),
          tab_widget: FaIcon(FontAwesomeIcons.magnifyingGlass)),
      CustomTabBarItem(
          page: PropertiesPage(), tab_widget: FaIcon(FontAwesomeIcons.house)),
      CustomTabBarItem(
          page: ConversationsPage(),
          tab_widget: FaIcon(FontAwesomeIcons.inbox)),
      CustomTabBarItem(
          page: ProfilePage(), tab_widget: FaIcon(FontAwesomeIcons.person)),
    ],
  )));
}
